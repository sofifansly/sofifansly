...
export const metadata = {
  title: 'Legal Notice - Gabby Epstein OnlyFans',
  description: 'Legal notice and terms of service for Gabby Epstein OnlyFans fan page',
  robots: {
    index: false,
    follow: true
  },
  alternates: {
    canonical: 'https://www.gabby-epstein-onlyfans.com/legal-notice'
  }
};
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none">
        <p className="mb-8">In accordance with the provisions of Articles 6-III and 19 of Law No. 2004-575 of June 21, 2004 for Confidence in the Digital Economy (L.C.E.N.), we inform users and visitors of the website kirstentoosweet-onlyfans.com of the following information:</p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Website Publisher</h2>
          <p className="mb-4">The website gabby epstein OnlyFans is published at: https://www.gabby-epstein-onlyfans.com/</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">All information provided on the website gabby epstein OnlyFans is for informational purposes only, is not exhaustive, and is subject to change.</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Intellectual Property</h2>
          <p className="mb-4">All content available on this site (texts, images, logos, etc.) is the exclusive property of gabby epstein OnlyFans, unless otherwise stated. Any reproduction, distribution, modification, adaptation, retransmission, or publication of such content, even partial, is strictly prohibited without the prior written consent of the publisher.</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Contact</h2>
          <p className="mb-4">For any inquiries, please <SecureEmail />.</p>
        </section>
      </div>
    </main>
  );
